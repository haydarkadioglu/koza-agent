...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/koza/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/koza...\n")
...
console.log("Fetching npm all-time downloads for koza-ai...\n")
const npmDownloads = await fetchNpmDownloads("koza-ai")
