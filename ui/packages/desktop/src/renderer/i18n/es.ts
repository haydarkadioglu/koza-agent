export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Koza",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Koza. ¿Quieres instalarla y reiniciar?",
