...
const releaseId = process.env.KOZA_RELEASE
if (!releaseId) throw new Error("KOZA_RELEASE is required")

const version = process.env.KOZA_VERSION
if (!version) throw new Error("KOZA_VERSION is required")
...
const macxTarGz = "koza-desktop-mac-x64.app.tar.gz"
const macaTarGz = "koza-desktop-mac-arm64.app.tar.gz"
