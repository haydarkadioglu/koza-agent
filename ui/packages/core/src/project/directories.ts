...
import type { EffectDrizzleSqlite } from "@koza-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@koza/ProjectDirectories") {}
