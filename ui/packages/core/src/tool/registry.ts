...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@koza-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/ToolRegistry") {}
