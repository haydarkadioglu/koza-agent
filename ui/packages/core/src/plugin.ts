...
import type { Plugin as PluginRuntime } from "@koza-ai/plugin/v2/effect"
import { Plugin } from "@koza-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/Plugin") {}
