...
import { Credential } from "@koza-ai/schema/credential"
import { Integration } from "@koza-ai/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/Credential") {}
