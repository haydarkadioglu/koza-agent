...
import { FileSystemWatcher } from "@koza-ai/schema/filesystem-watcher"
...
declare const KOZA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof KOZA_LIBC === "undefined" ? undefined : KOZA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.KOZA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.KOZA_EXPERIMENTAL_FILEWATCHER)) {
