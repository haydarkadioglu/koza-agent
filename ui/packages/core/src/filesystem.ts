...
import { Entry, FileSystem, FindInput, Match } from "@koza-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@koza-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/FileSystem") {}
