...
import { ListAnchor } from "@koza-ai/schema/session"
...
import { SessionDurable } from "@koza-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@koza/v2/Session") {}
