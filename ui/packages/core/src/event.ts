...
import type { Data, Definition, Payload } from "@koza-ai/schema/event"
...
import { Durable } from "@koza-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@koza-ai/schema/event").ID
export type { Data, Definition, Payload } from "@koza-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@koza/Event") {}
