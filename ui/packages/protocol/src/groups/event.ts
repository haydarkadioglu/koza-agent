...
import type { Definition } from "@koza-ai/schema/event"
...
export const KozaEvent = event.schema
export type KozaEvent = typeof KozaEvent.Type
export type KozaEventEncoded = typeof KozaEvent.Encoded
