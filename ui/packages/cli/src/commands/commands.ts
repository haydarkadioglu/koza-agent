...
declare const KOZA_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof KOZA_CLI_NAME === "string" ? KOZA_CLI_NAME : "koza", {
  description: "Koza 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
