...
class Database extends Context.Service<Database, DatabaseShape>()("@koza/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@koza/example/UserStore") {
