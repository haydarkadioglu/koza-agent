...
import { compile, emitEffectImported, emitPromise, write } from "@koza-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "KozaEventEncoded",
              import: 'import type { KozaEventEncoded } from "@koza-ai/protocol/groups/event"',
            },
          },
        }),
