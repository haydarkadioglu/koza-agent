...
Practical reference for the current tool-migration state in `packages/koza`.
...
Tool tests should use the existing Effect helpers in `packages/koza/test/lib/effect.ts`:
