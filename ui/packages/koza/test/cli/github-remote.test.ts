...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/koza.git")).toEqual({ owner: "sst", repo: "koza" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/koza")).toEqual({ owner: "sst", repo: "koza" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/koza.git")).toEqual({ owner: "sst", repo: "koza" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/koza")).toEqual({ owner: "sst", repo: "koza" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/koza.git")).toEqual({ owner: "sst", repo: "koza" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/koza")).toEqual({ owner: "sst", repo: "koza" })
})
