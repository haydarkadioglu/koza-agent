...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KOZA_CALLER", () => {
    process.env["KOZA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KOZA_CALLER", () => {
    process.env["KOZA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KOZA_CALLER", () => {
    process.env["KOZA_CALLER"] = "unknown"
