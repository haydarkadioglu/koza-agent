...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips koza-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-koza-directory"]).toBeUndefined()
      expect(forwarded["x-koza-workspace"]).toBeUndefined()
