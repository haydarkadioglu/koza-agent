...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips koza-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-koza-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-koza-directory")).toBeNull()
      expect(result.get("x-koza-workspace")).toBeNull()
