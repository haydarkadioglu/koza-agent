import type { Hooks, PluginInput } from "@koza-ai/plugin"
import type { Model } from "@koza-ai/sdk/v2"
import { InstallationVersion } from "@koza-ai/core/installation/version"
import { OauthCallbackPage } from "@koza-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Koza will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
