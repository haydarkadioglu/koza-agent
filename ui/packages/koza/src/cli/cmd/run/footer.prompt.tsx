...
import { normalizePromptContent } from "@koza-ai/tui/editor"
...
import { KOZA_BASE_MODE, useBindings } from "@koza-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Koza" } satisfies SlashOption,
    ]
