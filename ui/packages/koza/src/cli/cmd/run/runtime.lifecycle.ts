...
import { openEditor } from "@koza-ai/tui/editor"
import { registerKozaKeymap } from "@koza-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerKozaKeymap(keymap, renderer, input.tuiConfig)
