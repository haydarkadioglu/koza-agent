...
>()("@koza/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@koza/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.KOZA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.KOZA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-koza-directory"] || process.cwd()
}
