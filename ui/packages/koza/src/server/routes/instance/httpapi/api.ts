...
import { makeApi } from "@koza-ai/protocol/api"
import { LocationMiddleware } from "@koza-ai/server/location"
import { SessionLocationMiddleware } from "@koza-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("koza-root")
...
export const InstanceHttpApi = HttpApi.make("koza-instance")
...
export const KozaHttpApi = HttpApi.make("koza")
