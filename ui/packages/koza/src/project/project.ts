...
import { ProjectDirectoryTable, ProjectTable } from "@koza-ai/core/project/sql"
import { ProjectDirectories } from "@koza-ai/core/project/directories"
...
import { which } from "@koza-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@koza/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.KOZA_FAKE_VCS)
