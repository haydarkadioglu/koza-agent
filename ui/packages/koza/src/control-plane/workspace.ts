...
import { EventSequenceTable, EventTable } from "@koza-ai/core/event/sql"
...
import { WorkspaceEvent } from "@koza-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@koza/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        KOZA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        KOZA_WORKSPACE_ID: config.id,
        KOZA_EXPERIMENTAL_WORKSPACES: "true",
