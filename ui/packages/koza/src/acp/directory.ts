...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@koza/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@koza/ACPDirectory") {}
