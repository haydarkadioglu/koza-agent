...
export class Service extends Context.Service<Service, Interface>()("@koza/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __KOZA_PHOTON_WASM_PATH?: string }).__KOZA_PHOTON_WASM_PATH =
