 ...
 *   "@koza/ServerAuthConfig",
 *   {
 *     password: Config.string("KOZA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("KOZA_SERVER_USERNAME").pipe(Config.withDefault("koza")),
 *   },
 * ) {}
 *
