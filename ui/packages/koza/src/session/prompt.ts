...
import { MAX_STEPS_PROMPT } from "@koza-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@koza-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@koza/SessionPrompt") {}
