...
import { locationServiceMapLayer } from "@koza-ai/core/location-services"
...
import { PartTable, SessionTable } from "@koza-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@koza-ai/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProviderV2 } from "@koza-ai/core/provider"
import { ModelV2 } from "@koza-ai/core/model"
import { SessionMessage } from "@koza-ai/schema/session-message"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".koza", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@koza/Session") {}
