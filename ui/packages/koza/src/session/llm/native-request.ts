import type { JsonSchema, LLMRequest, ProviderMetadata } from "@koza-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@koza-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @koza-ai/llm request objects from koza's session/AI SDK-shaped data.
  return LLM.request({
