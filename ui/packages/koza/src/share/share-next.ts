...
import type * as SDK from "@koza-ai/sdk/v2"
...
import { SessionShareTable } from "@koza-ai/core/share/sql"
import { ProviderV2 } from "@koza-ai/core/provider"
import { ModelV2 } from "@koza-ai/core/model"
import { EventV2 } from "@koza-ai/core/event"

const disabled = process.env["KOZA_DISABLE_SHARE"] === "true" || process.env["KOZA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@koza/ShareNext") {}
