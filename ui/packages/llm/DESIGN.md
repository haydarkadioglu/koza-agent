...
> current private `@koza-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@koza-ai/ai`
...
- Secondary audience: Koza and other durable agent runtimes
...
import { LLM } from "@koza-ai/ai"
import { OpenAI } from "@koza-ai/ai/providers/openai"
...
```ts
import { Message } from "@koza-ai/ai"
...
import { LLM, Tool } from "@koza-ai/ai"
...
Koza and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@koza-ai/ai/promise"
import { OpenAI } from "@koza-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@koza-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@koza-ai/ai/provider"
...
@koza-ai/ai/providers/openai
@koza-ai/ai/providers/anthropic
@koza-ai/ai/providers/google
...
```
...
Koza should migrate to `generateTurn` / `streamTurn`, preserving its durable
