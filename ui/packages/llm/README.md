...
Schema-first LLM core for koza. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@koza-ai/llm"
import { OpenAI } from "@koza-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@koza-ai/llm/providers"
