...
import defaultSoundPath from "@koza-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@koza-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@koza-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@koza-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@koza-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@koza-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "koza"
const DEFAULT_PACK_ID = "koza.default"
