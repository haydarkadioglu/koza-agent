...
import { registerKozaSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@koza-ai/sdk/v2"
...
import { KOZA_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useKozaKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.KOZA_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
