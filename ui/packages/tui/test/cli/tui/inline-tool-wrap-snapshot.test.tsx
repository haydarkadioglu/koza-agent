...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "KOZA.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/koza/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/koza (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/koza/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/koza/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const KOZA_DB|KOZA_DB|KOZA_DEV|Global\\.Path\\.data|data =" in packages/koza/src (115 matches)',
  },
] as const
