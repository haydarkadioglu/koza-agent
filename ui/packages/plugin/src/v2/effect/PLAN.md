...
- Effect plugins import `@koza-ai/plugin/v2/effect`, not `@koza-ai/core`.
- Public domain values use generated `@koza-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@koza-ai/plugin/v2/effect`.
