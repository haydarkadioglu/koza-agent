...
import type { FileSearchHandle } from "@koza-ai/session-ui/file"
import { useFileComponent } from "@koza-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@koza-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@koza-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@koza-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@koza-ai/core/util/encode"
import { DropdownMenu } from "@koza-ai/ui/dropdown-menu"
import { IconButton } from "@koza-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@koza-ai/ui/v2/line-comment-v2"
import { MenuV2 } from "@koza-ai/ui/v2/menu-v2"
import { Tabs } from "@koza-ai/ui/tabs"
import { ScrollView } from "@koza-ai/ui/scroll-view"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--koza-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
          current: state()?.content,
