...
import { setVoiceModeActive } from "@/components/voice/store"
...
import { Session } from "@koza-ai/sdk/v2/client"
...
import { toaster } from "@koza-ai/ui/toast"
...
import { Binary } from "@koza-ai/core/util/binary"
...
import { useTheme, type ColorScheme } from "@koza-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenKozaEngine={() => openSettings("koza")}
      onOpenMCP={() => openSettings("mcp")}
      onOpenVoiceSync={() => setVoiceModeActive(true)}
      helpLabel={() => language.t("sidebar.help")}
      onOpenHelp={() => platform.openLink("https://koza.ai/desktop-feedback")}
      renderPanel={() =>
