export const dict = {
  ...
  "dialog.provider.koza.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.koza.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.kozaGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Koza",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Koza-u.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.kozaZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.kozaZen.visit.prefix": "Posjeti ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Koza-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Koza-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u koza.json",
  ...
  "dialog.server.description": "Promijeni na koji se Koza server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingKoza": "Provjera Koza...",
  "wsl.onboarding.checkingKozaIn": "Provjera Koza u distribuciji {{distro}}...",
  "wsl.onboarding.updatingKoza": "Ažuriranje Koza...",
  "wsl.onboarding.updatingKozaIn": "Ažuriranje Koza u distribuciji {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Ažuriraj Koza u distribuciji {{distro}}.",
  "wsl.onboarding.updateKoza": "Ažuriraj Koza",
  "wsl.onboarding.kozaReadyIn": "Koza je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza je spreman.",
  "wsl.onboarding.installKozaIn": "Instaliraj Koza u distribuciji {{distro}}.",
  "wsl.onboarding.installKoza": "Instaliraj Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Koza mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Koza nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Koza.",
  ...
  "toast.update.description": "Nova verzija Koza-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Koza timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (koza.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Koza još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Koza uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Koza server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Koza-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Koza izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Koza prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Koza-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Koza pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Koza-a.",
