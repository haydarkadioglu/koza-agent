export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Koza 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Koza 확인 중...",
  "wsl.onboarding.updatingOpencode": "Koza 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Koza 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Koza를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Koza 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Koza를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Koza가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Koza를 설치하세요.",
  "wsl.onboarding.installOpencode": "Koza 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koza가 설치되지 않음",
