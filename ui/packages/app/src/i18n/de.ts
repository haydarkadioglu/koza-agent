...
export const dict = {
  ...
  "dialog.provider.koza.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.koza.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.kozaGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Koza",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Koza zu nutzen.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.kozaZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Koza zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Koza zu nutzen.",
  ...
  "dialog.plugins.empty": "In koza.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Koza-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingKoza": "Koza wird geprüft...",
  "wsl.onboarding.checkingKozaIn": "Koza in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingKoza": "Koza wird aktualisiert...",
  "wsl.onboarding.updatingKozaIn": "Koza in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateKozaIn": "Aktualisieren Sie Koza in {{distro}}.",
  "wsl.onboarding.updateKoza": "Koza aktualisieren",
  "wsl.onboarding.kozaReadyIn": "Koza ist in {{distro}} bereit.",
  "wsl.onboarding.kozaReady": "Koza ist bereit.",
  "wsl.onboarding.installKozaIn": "Installieren Sie Koza in {{distro}}.",
  "wsl.onboarding.installKoza": "Koza installieren",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Koza einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Koza konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Koza erneut.",
  ...
  "toast.update.description": "Eine neue Version von Koza ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Koza-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (koza.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Koza unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Koza enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Koza-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Koza ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Koza auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Koza dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Koza anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Koza automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Koza.",
