...
export const dict = {
  ...
  "dialog.provider.koza.note": "使用 Koza Zen 或 API 密钥连接",
  "dialog.provider.koza.tagline": "可靠的优化模型",
  "dialog.provider.kozaGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Koza 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Koza 中使用 {{provider}} 模型。",
  ...
  "provider.connect.kozaZen.line1": "Koza Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.kozaZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.kozaZen.visit.prefix": "访问 ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Koza 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Koza 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 koza.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Koza 服务器。",
  ...
  "wsl.onboarding.checkingKoza": "正在检查 Koza...",
  "wsl.onboarding.checkingKozaIn": "正在检查 {{distro}} 中的 Koza...",
  "wsl.onboarding.updatingKoza": "正在更新 Koza...",
  "wsl.onboarding.updatingKozaIn": "正在更新 {{distro}} 中的 Koza...",
  "wsl.onboarding.updateKozaIn": "更新 {{distro}} 中的 Koza。",
  "wsl.onboarding.updateKoza": "更新 Koza",
  "wsl.onboarding.kozaReadyIn": "{{distro}} 中的 Koza 已就绪。",
  "wsl.onboarding.kozaReady": "Koza 已就绪。",
  "wsl.onboarding.installKozaIn": "在 {{distro}} 中安装 Koza。",
  "wsl.onboarding.installKoza": "安装 Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "未安装 Koza",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Koza 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Koza 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Koza。",
  ...
  "toast.update.description": "Koza 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Koza 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (koza.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Koza 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Koza 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Koza 服务器。",
  ...
  "settings.general.row.language.description": "更改 Koza 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Koza 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Koza 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Koza 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Koza 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Koza。",
