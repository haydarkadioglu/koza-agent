export const dict = {
  ...
  "dialog.provider.koza.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.koza.tagline": "Reliable optimized models",
  "dialog.provider.kozaGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Koza",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Koza.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.kozaZen.line1":
    "Koza Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.kozaZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.kozaZen.visit.prefix": "Visit ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Koza.",
  ...
  "dialog.plugins.empty": "Plugins configured in config.yaml",
  ...
  "dialog.server.description": "Switch which Koza server this app connects to.",
  ...
  "wsl.onboarding.checkingKoza": "Checking Koza...",
  "wsl.onboarding.checkingKozaIn": "Checking Koza in {{distro}}...",
  "wsl.onboarding.updatingKoza": "Updating Koza...",
  "wsl.onboarding.updatingKozaIn": "Updating Koza in {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Update Koza in {{distro}}.",
  "wsl.onboarding.updateKoza": "Update Koza",
  "wsl.onboarding.kozaReadyIn": "Koza is ready in {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza is ready.",
  "wsl.onboarding.installKozaIn": "Install Koza in {{distro}}.",
  "wsl.onboarding.installKoza": "Install Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Koza can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Koza could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Koza.",
  ...
  "toast.update.description": "A new version of Koza ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Koza team",
  ...
  "error.chain.checkConfig": "Check your config (config.yaml) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Koza does not support MCP authentication yet.',
  ...
  "home.empty.description": "Get started by creating a session",
  "home.title": "Home",
  "home.projects": "Sessions",
  "home.project.add": "Add session",
  "home.recentlyClosed": "Recently closed",
  "home.server.collapse": "Collapse server sessions",
  "home.server.expand": "Expand server sessions",
  ...
  "sidebar.nav.projectsAndSessions": "Sessions",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Koza includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.clearNotifications": "Clear notifications",
  "sidebar.empty.title": "No sessions open",
  "sidebar.empty.description": "Create a session to get started",
  ...
  "settings.desktop.wsl.description": "Run the Koza server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Koza",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Koza looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Koza follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Koza is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Koza launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Koza.",
