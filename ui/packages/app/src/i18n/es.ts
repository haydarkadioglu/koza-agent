export const dict = {
  ...
  "dialog.provider.koza.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.koza.tagline": "Modelos optimizados y fiables",
  "dialog.provider.kozaGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Koza",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.kozaZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.kozaZen.visit.prefix": "Visita ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Koza.",
  ...
  "dialog.plugins.empty": "Plugins configurados en koza.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Koza se conecta esta app.",
  ...
  "wsl.onboarding.checkingKoza": "Comprobando Koza...",
  "wsl.onboarding.checkingKozaIn": "Comprobando Koza en {{distro}}...",
  "wsl.onboarding.updatingKoza": "Actualizando Koza...",
  "wsl.onboarding.updatingKozaIn": "Actualizando Koza en {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Actualiza Koza en {{distro}}.",
  "wsl.onboarding.updateKoza": "Actualizar Koza",
  "wsl.onboarding.kozaReadyIn": "Koza está listo en {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza está listo.",
  "wsl.onboarding.installKozaIn": "Instala Koza en {{distro}}.",
  "wsl.onboarding.installKoza": "Instalar Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Koza pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Koza no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Koza.",
  ...
  "toast.update.description": "Una nueva versión de Koza ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Koza",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (koza.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Koza no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Koza incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Koza dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Koza",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Koza en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Koza sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Koza.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Koza",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Koza.",
