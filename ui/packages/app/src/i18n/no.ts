...
export const dict = {
  ...
  "dialog.provider.koza.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.koza.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.kozaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Koza",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.kozaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kozaZen.visit.prefix": "Besøk ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Koza.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i koza.json",
  ...
  "dialog.server.description": "Bytt hvilken Koza-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Koza ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Koza-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (koza.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Koza ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Koza inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Koza-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Koza",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Koza ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Koza skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Koza er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Koza starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Koza.",
  ...
  "wsl.onboarding.checkingKoza": "Sjekker Koza...",
  "wsl.onboarding.checkingKozaIn": "Sjekker Koza i {{distro}}...",
  "wsl.onboarding.updatingKoza": "Oppdaterer Koza...",
  "wsl.onboarding.updatingKozaIn": "Oppdaterer Koza i {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Oppdater Koza i {{distro}}.",
  "wsl.onboarding.updateKoza": "Oppdater Koza",
  "wsl.onboarding.kozaReadyIn": "Koza er klar i {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza er klar.",
  "wsl.onboarding.installKozaIn": "Installer Koza i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Koza kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Koza kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Koza på nytt.",
