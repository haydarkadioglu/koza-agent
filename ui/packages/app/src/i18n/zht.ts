...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1": "Koza Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Koza...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Koza...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Koza 已就緒。",
  "wsl.onboarding.opencodeReady": "Koza 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Koza。",
  "wsl.onboarding.installOpencode": "安裝 Koza",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Koza",
