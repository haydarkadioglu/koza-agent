...
export const dict = {
  ...
  "dialog.provider.koza.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.koza.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.kozaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Koza tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Koza'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  "provider.connect.kozaZen.line2":
    "Tek bir API anahtarıyla Claude, GPT, Gemini, GLM ve daha fazlası gibi modellere erişebilirsiniz.",
  "provider.connect.kozaZen.visit.prefix": "",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Koza'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Koza'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler config.yaml içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Koza sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingKoza": "Koza kontrol ediliyor...",
  "wsl.onboarding.checkingKozaIn": "{{distro}} içinde Koza kontrol ediliyor...",
  "wsl.onboarding.updatingKoza": "Koza güncelleniyor...",
  "wsl.onboarding.updatingKozaIn": "{{distro}} içinde Koza güncelleniyor...",
  "wsl.onboarding.updateKozaIn": "{{distro}} içindeki Koza'yı güncelleyin.",
  "wsl.onboarding.updateKoza": "Koza'yı güncelle",
  "wsl.onboarding.kozaReadyIn": "{{distro}} içinde Koza hazır.",
  "wsl.onboarding.kozaReady": "Koza hazır.",
  "wsl.onboarding.installKozaIn": "Koza'yı {{distro}} içine kurun.",
  "wsl.onboarding.installKoza": "Koza'yı kur",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koza'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Koza bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Koza'u tekrar açın.",
  ...
  "toast.update.description": "Koza'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Koza ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (config.yaml) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Koza henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "home.recentProjects": "Son oturumlar",
  "home.empty.title": "Son oturum yok",
  "home.empty.description": "Bir oturum oluşturarak başlayın",
  "home.title": "Ana Sayfa",
  "home.projects": "Oturumlar",
  "home.project.add": "Oturum oluştur",
  "home.recentlyClosed": "Yakın zamanda kapatılanlar",
  "home.server.collapse": "Sunucu oturumlarını daralt",
  "home.server.expand": "Sunucu oturumlarını genişlet",
  ...
  "sidebar.nav.projectsAndSessions": "Oturumlar",
  ...
  "sidebar.gettingStarted.line1": "Koza ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "sidebar.empty.title": "Açık oturum yok",
  "sidebar.empty.description": "Başlamak için bir oturum oluşturun",

  "app.name.desktop": "Koza Masaüstü",
  ...
  "settings.desktop.wsl.description": "Koza sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Koza'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Koza'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Koza'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Koza'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Koza başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Koza'un en son sürümünü kullanıyorsunuz.",
