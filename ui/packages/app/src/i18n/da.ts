export const dict = {
  ...
  "dialog.provider.koza.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.koza.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.kozaGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Koza",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.kozaZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.kozaZen.visit.prefix": "Besøg ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Koza.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i koza.json",
  ...
  "dialog.server.description": "Skift hvilken Koza-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingKoza": "Tjekker Koza...",
  "wsl.onboarding.checkingKozaIn": "Tjekker Koza i {{distro}}...",
  "wsl.onboarding.updatingKoza": "Opdaterer Koza...",
  "wsl.onboarding.updatingKozaIn": "Opdaterer Koza i {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Opdater Koza i {{distro}}.",
  "wsl.onboarding.updateKoza": "Opdater Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Koza kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Koza kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Koza igen.",
  ...
  "toast.update.description": "En ny version af Koza ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Koza-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (koza.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Koza understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Koza inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Koza-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Koza",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Koza ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Koza følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Koza er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Koza starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Koza.",
