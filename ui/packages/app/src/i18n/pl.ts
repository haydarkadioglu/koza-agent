export const dict = {
  ...
  "dialog.provider.koza.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.koza.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.kozaGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Koza",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.kozaZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.kozaZen.visit.prefix": "Odwiedź ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Koza.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w koza.json",
  ...
  "dialog.server.description": "Przełącz serwer Koza, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingKoza": "Sprawdzanie Koza...",
  "wsl.onboarding.checkingKozaIn": "Sprawdzanie Koza w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingKoza": "Aktualizowanie Koza...",
  "wsl.onboarding.updatingKozaIn": "Aktualizowanie Koza w dystrybucji {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Zaktualizuj Koza w dystrybucji {{distro}}.",
  "wsl.onboarding.updateKoza": "Zaktualizuj Koza",
  "wsl.onboarding.kozaReadyIn": "Koza jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza jest gotowy.",
  "wsl.onboarding.installKozaIn": "Zainstaluj Koza w dystrybucji {{distro}}.",
  "wsl.onboarding.installKoza": "Zainstaluj Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Koza będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Koza nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Koza.",
  ...
  "toast.update.description": "Nowa wersja Koza ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Koza",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (koza.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Koza nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Koza zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Koza wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Koza",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Koza na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Koza ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Koza.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Koza",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Koza.",
