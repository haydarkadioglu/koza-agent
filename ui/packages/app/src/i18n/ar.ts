export const dict = {
  ...
  "dialog.provider.koza.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.koza.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.kozaGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Koza",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "يمنحك Koza Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.kozaZen.visit.prefix": "قم بزيارة ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Koza.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في koza.json",
  ...
  "dialog.server.description": "تبديل خادم Koza الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingKoza": "جارٍ التحقق من Koza...",
  "wsl.onboarding.checkingKozaIn": "جارٍ التحقق من Koza في {{distro}}...",
  "wsl.onboarding.updatingKoza": "جارٍ تحديث Koza...",
  "wsl.onboarding.updatingKozaIn": "جارٍ تحديث Koza في {{distro}}...",
  "wsl.onboarding.updateKozaIn": "حدّث Koza في {{distro}}.",
  "wsl.onboarding.updateKoza": "تحديث Koza",
  "wsl.onboarding.kozaReadyIn": "Koza جاهز في {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza جاهز.",
  "wsl.onboarding.installKozaIn": "ثبّت Koza في {{distro}}.",
  "wsl.onboarding.installKoza": "تثبيت Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Koza من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Koza التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Koza.",
  ...
  "toast.update.description": "نسخة جديدة من Koza ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Koza",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (koza.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Koza لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Koza نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Koza داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Koza",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Koza على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Koza يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Koza.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Koza",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Koza.",
