export const dict = {
  ...
  "dialog.provider.koza.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.koza.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.kozaGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Koza",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.kozaZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.kozaZen.visit.prefix": "Visite ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Koza.",
  ...
  "dialog.plugins.empty": "Plugins configurados em koza.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Koza este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingKoza": "Verificando o Koza...",
  "wsl.onboarding.checkingKozaIn": "Verificando o Koza em {{distro}}...",
  "wsl.onboarding.updatingKoza": "Atualizando o Koza...",
  "wsl.onboarding.updatingKozaIn": "Atualizando o Koza em {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Atualize o Koza em {{distro}}.",
  "wsl.onboarding.updateKoza": "Atualizar o Koza",
  "wsl.onboarding.kozaReadyIn": "O Koza está pronto em {{distro}}.",
  "wsl.onboarding.kozaReady": "O Koza está pronto.",
  "wsl.onboarding.installKozaIn": "Instale o Koza em {{distro}}.",
  "wsl.onboarding.installKoza": "Instalar o Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Koza possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Koza não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Koza novamente.",
  ...
  "toast.update.description": "Uma nova versão do Koza ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Koza",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (koza.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Koza ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koza inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Koza dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Koza",
  ...
  "settings.general.row.appearance.description": "Personalize como o Koza aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Koza segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Koza é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Koza iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Koza.",
