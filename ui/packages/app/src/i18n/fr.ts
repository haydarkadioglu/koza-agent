export const dict = {
  ...
  "dialog.provider.koza.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.koza.tagline": "Modèles optimisés et fiables",
  "dialog.provider.kozaGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Koza",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Koza.",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.kozaZen.visit.prefix": "Visitez ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Koza.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Koza.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans koza.json",
  ...
  "dialog.server.description": "Changez le serveur Koza auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingKoza": "Vérification d'Koza...",
  "wsl.onboarding.checkingKozaIn": "Vérification d'Koza dans {{distro}}...",
  "wsl.onboarding.updatingKoza": "Mise à jour d'Koza...",
  "wsl.onboarding.updatingKozaIn": "Mise à jour d'Koza dans {{distro}}...",
  "wsl.onboarding.updateKozaIn": "Mettez à jour Koza dans {{distro}}.",
  "wsl.onboarding.updateKoza": "Mettre à jour Koza",
  "wsl.onboarding.kozaReadyIn": "Koza est prêt dans {{distro}}.",
  "wsl.onboarding.kozaReady": "Koza est prêt.",
  "wsl.onboarding.installKozaIn": "Installez Koza dans {{distro}}.",
  "wsl.onboarding.installKoza": "Installer Koza",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Koza non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Koza puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Koza n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Koza.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Koza ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Koza",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (koza.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Koza ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Koza inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Koza dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Koza",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Koza sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Koza suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Koza.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Koza",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Koza.",
