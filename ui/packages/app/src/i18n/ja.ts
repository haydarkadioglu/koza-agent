export const dict = {
  ...
  "dialog.provider.koza.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.koza.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.kozaGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Kozaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Kozaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.kozaZen.line1":
    "Koza Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.kozaZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.kozaZen.visit.prefix": " ",
  "provider.connect.kozaZen.visit.link": "koza.ai/zen",
  "provider.connect.kozaZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKozaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Kozaで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "koza.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するKozaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingKoza": "Kozaを確認中...",
  "wsl.onboarding.checkingKozaIn": "{{distro}}内のKozaを確認中...",
  "wsl.onboarding.updatingKoza": "Kozaを更新中...",
  "wsl.onboarding.updatingKozaIn": "{{distro}}内のKozaを更新中...",
  "wsl.onboarding.updateKozaIn": "{{distro}}内のKozaを更新してください。",
  "wsl.onboarding.updateKoza": "Kozaを更新",
  "wsl.onboarding.kozaReadyIn": "{{distro}}内のKozaの準備ができました。",
  "wsl.onboarding.kozaReady": "Kozaの準備ができました。",
  "wsl.onboarding.installKozaIn": "{{distro}}にKozaをインストールしてください。",
  "wsl.onboarding.installKoza": "Kozaをインストール",
  ...
  "wsl.onboarding.distroStatus.kozaMissing": "Kozaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KozaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Kozaをもう一度開いてください。",
  ...
  "toast.update.description": "Kozaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKozaチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (koza.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KozaはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Kozaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKozaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Kozaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKozaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Kozaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Kozaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Koza の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Koza は最新バージョンです。",
