export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Kozaを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKozaを確認中...",
  "wsl.onboarding.updatingOpencode": "Kozaを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKozaを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKozaを更新してください。",
  "wsl.onboarding.updateOpencode": "Kozaを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のKozaの準備ができました。",
  "wsl.onboarding.opencodeReady": "Kozaの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKozaをインストールしてください。",
  "wsl.onboarding.installOpencode": "Kozaをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kozaがインストールされていません",
