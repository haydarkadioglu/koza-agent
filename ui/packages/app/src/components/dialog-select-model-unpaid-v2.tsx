...
const featuredProviders = ["koza", "koza-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "koza" && (!item.cost || item.cost.input === 0)
                  ...
                  {(provider) => (
                    ...
                    >
                      ...
                      <span class="flex min-w-0 flex-col">
                        ...
                        <Show when={provider.id === "koza" || provider.id === "koza-go"}>
