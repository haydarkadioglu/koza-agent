...
beforeAll(async () => {
  ...
  mock.module("@koza-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@koza-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@koza-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@koza-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
