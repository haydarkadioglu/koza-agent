...
const GLOBAL_STORAGE = "koza.global.dat"
const WINDOW_STORAGE = "koza.window"
const LOCAL_PREFIX = "koza."
...
function workspaceStorage(dir: string) {
  ...
  return `koza.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `koza.draft.${head}.${sum}.dat`
}
