...
export const TypeId: TypeId = "~@koza-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@koza-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@koza-ai/effect-sqlite-node/NodeSqliteClient")
