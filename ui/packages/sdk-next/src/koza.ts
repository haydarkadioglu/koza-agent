import { Koza } from "@koza-ai/client/effect"
...
import { createEmbeddedRoutes } from "@koza-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Koza.create")(function* () {
  ...
  const client = yield* Koza.make({ baseUrl: "http://koza.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@koza-ai/sdk-next/Koza") {}
