---
title: Zen
description: koza tarafından sağlanan seçilmiş modeller listesi.
---
...
Koza Zen, Koza ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Koza'daki diğer sağlayıcılar gibi çalışır. Koza Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Koza kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Koza ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Koza Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Koza Zen, Koza'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Koza Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Koza Zen'i seçin ve API anahtarınızı yapıştırın.
...
Koza yapılandırmanızdaki [model id](/docs/config/#models) `koza/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `koza/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Koza'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Koza'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Koza'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Koza'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Koza'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Koza Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Koza ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
