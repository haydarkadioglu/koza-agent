---
title: Özel Araçlar
description: LLM'un koza'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. koza'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.koza/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/koza/tools/` içine yerleştirerek.
