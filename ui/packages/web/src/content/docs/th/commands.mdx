...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Koza:
...
- ระดับผู้ใช้ (Global): `~/.config/koza/commands/`
- ระดับโปรเจ็กต์: `.koza/commands/`
...
Koza มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
