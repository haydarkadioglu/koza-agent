...
Brug den til at bygge integrasjoner og kontrollere koza programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `koza.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av koza, kan du oprete en klientforekomst for at koble til den:
