---
title: LSP-servere
description: Koza integreres med dine LSP-servere.
---

Koza kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Koza leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `KOZA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og koza åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din koza-konfiguration.
