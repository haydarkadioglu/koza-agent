...
Du kan tilføje brugerdefinerede kommandoer gennem Koza-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Koza [config](/docs/config):
...
- Globalt: `~/.config/koza/commands/`
- Pr. projekt: `.koza/commands/`
...
koza indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
