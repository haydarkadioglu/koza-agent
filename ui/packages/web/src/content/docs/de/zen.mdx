---
title: Zen
description: Kuratierte Modellliste direkt von Koza.
---
...
Koza Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Koza-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Koza. Du meldest dich bei Koza Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Koza zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Koza funktionieren.
:::
...
Koza Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Koza Zen funktioniert wie jeder andere Provider in Koza.

1. Du meldest dich bei **<a href={console}>Koza Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Koza Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Koza-Konfiguration verwendet das Format `koza/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `koza/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf Koza verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf Koza verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf Koza verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Koza verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Koza verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Koza Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Koza auch jeden anderen Provider zu verwenden.
