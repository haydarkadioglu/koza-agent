---
title: Teilen
description: Teile Koza-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Koza-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Koza Folgendes:
...
Koza hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Koza den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`koza.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du koza in deiner Organisation einsetzt.
