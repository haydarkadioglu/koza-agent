...
Możesz zdefiniować polecenia w `koza.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji koza:
...
- Globalnie: `~/.config/koza/commands/`
- Na projekt: `.koza/commands/`
...
koza zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
