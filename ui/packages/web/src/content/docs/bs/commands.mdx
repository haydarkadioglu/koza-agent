...
Možete dodati prilagođene komande kroz Koza konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Koza [config](/docs/config):
...
- Globalno: `~/.config/koza/commands/`
- Po projektu: `.koza/commands/`
...
Koza uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
