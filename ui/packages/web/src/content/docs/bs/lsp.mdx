---
title: LSP serveri
description: Koza se integriše sa vašim LSP serverima.
---

Koza se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Koza dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `KOZA_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i koza otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj koza konfiguraciji.
