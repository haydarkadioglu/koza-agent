---
title: TUI
description: Korištenje korisničkog interfejsa Koza terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Koza pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Koza pokreće TUI za trenutni direktorij.
...
Kada koristite Koza TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Koza. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Koza. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `koza.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Koza čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `koza.default`.
