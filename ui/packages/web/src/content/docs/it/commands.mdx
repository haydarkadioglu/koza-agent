...
Puoi aggiungere comandi personalizzati tramite la config di Koza o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Koza:
...
- Globale: `~/.config/koza/commands/`
- Per progetto: `.koza/commands/`
...
koza include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
