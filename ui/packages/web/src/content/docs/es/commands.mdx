...
Puede agregar comandos personalizados a través de la configuración Koza o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Koza [config](/docs/config):
...
koza incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
