...
import { IconKoza } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "koza/session/message-v2"
import type { Message } from "koza/session/message"
import type { Session } from "koza/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.koza_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.koza_name}>
                    <IconKoza width={16} height={16} />
                  </div>
